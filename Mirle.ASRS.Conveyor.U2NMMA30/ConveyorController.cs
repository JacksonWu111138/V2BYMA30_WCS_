...
using Mirle.ASRS.Conveyor.U2NMMA30.Events;
using System.Linq;
...
namespace Mirle.ASRS.Conveyor.U2NMMA30
{
    public class ConveyorController : IDisposable
    {
        ...
        public static readonly int[] CycleIndex = new int[]
        { 1, 2, 3, 7, 8, 9, 13, 14, 15, 19, 20, 21, 25, 26, 27, 28, 29, 30, 31, 32, 33, 45, 34, 35, 47, 36, 37,
            49, 38, 39, 40, 46, 41, 48, 42, 50, 43 };

        public static int CycleCount;

        public static int CycleCountMax;
