...
namespace Mirle.ASRS.Conveyor.U2NMMA30.Signal
{
    public class SignalMapper
    {
        ...
        {
            new BlockInfo(new DDeviceRange("D1001", "D3600"), "ReadWrite", 0),
        };
        ...
        private void MappingBuffer()
        {
            ...
            for (int i = 1; i <= BufferCount; i++)
            {
                ...
                bufferSignal.StatusSignal = new BufferStatusSignal
                {
                    ...
                    Error = new Bit(_mplc, $"D{startAddress + offset + 3}.4"),
                    Auto = new Bit(_mplc, $"D{startAddress + offset + 3}.5"),
                    Manual = new Bit(_mplc, $"D{startAddress + offset + 3}.6"),
                    Presence = new Bit(_mplc, $"D{startAddress + offset + 3}.7"),
