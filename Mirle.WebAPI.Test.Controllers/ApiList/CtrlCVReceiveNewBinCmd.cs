...
namespace Mirle.WebAPI.Test.Controllers.ApiList
{
    public partial class CtrlCVReceiveNewBinCmd : Form
    {
        ...
        public CtrlCVReceiveNewBinCmd(WebApiConfig TowerApi_config, WebApiConfig SmtcApi_config, WebApiConfig E04Api_config,
        ...
        private void button_CVReceiveNewBinCmd_Click(object sender, EventArgs e)
        {
            ...
            if(ctrltype)
            {
                ...
                if (!api.GetCV_ReceiveNewBinCmd().FunReport(info, Apiconfig.IP))
                {
